...
| W-03 | Profile edit language selector has hardcoded "English" / "Simplified Chinese" labels                                                                                           | Fixed: replaced with `t.profile.languageEnglish` / `t.profile.languageChinese` i18n keys; added keys to both en.json and zh-CN.json |
